...
! Constituent, tributary, and widthdrawal totals
  ...
  ALLOCATE (SDK1(NWB),sdk2(nwb),SEDCI1(NWB),SEDCI2(NWB),SEDPRC1(NWB),SEDPRC2(NWB),SEDCC1(NWB),SEDCC2(NWB))   ! Amaila
...
! CEMA and Amaila start
   kfname2(122) = 'DOH2S';kfname2(123)= 'DOCH4';kfname2(124) = 'H2SGASX';kfname2(125) = 'CH4GASX'
   kfname2(126) = 'H2SDK'; kfname2(127) = 'CH4DK'; kfname2(128) = 'SD_C_IN'; kfname2(129) = 'SD_N_IN'
   kfname2(130) = 'SD_P_IN'
   kfname2(131) = 'DOSEDIA';kfname2(132) = 'Fe2D';kfname2(133) = 'DOFe2';kfname2(134) = 'SDINFeOOH'
   kfname2(135) = 'SDINMnO2';kfname2(136) = 'Mn2d';kfname2(137) = 'DOMn2'
   kfname2(138) = 'SEDD1';kfname2(139) = 'SEDD2'
! CEMA end
  READ (CON,'(/)')
  DO JC=1,NCT
...
! Variable names, formats, multipliers, and Compaq Visual FORTRAN array viewer controls
  ...
  READ (GRF,'(// (A43,1X,A9,3F8.0,A8))') (CDNAME(J), FMTCD(J), CDMULT(J), CDMIN(J), CDMAX(J), CDPLTC(J),J=1,NDC-1)   ! SW 10/20/15 INTERNAL TDG
  CLOSE (GRF)
