Subroutine CEMA_W2_Input
    ...
    Read(CEMAFilN,*)MessageTemp, GasDiff_Sed
	...
	Allocate(FirstBubblesRelease(IMX,NumBubRelArr), BubblesReleaseAllValue(IMX,NumBubRelArr))
	...
	Allocate(SedGenBODSS(NumGenBODConstituents))
