...
!    Common /CEMACmBl1/ CEMAShieldsNumber, SScour, SNetFlx
    ...
    Entry SetupCEMASedimentModel
        ...
        Do RegnNum = 1, NumConsolidRegns
            Call InitializeBedConsolidationFiles(1210+RegnNum, ConsolidRateRegnFil(RegnNum))
        End Do !RegnNum 
            ...
            Do JB=BS(JW),BE(JW)
                ...
                Do SegNumI = IU, ID
                    ...
                    If(ConsolidationType(RegnNum) == 1)Then    !Time varying value
                        Call ReadBedConsolidationFiles(1210+RegnNum, ConsolidRateTemp)
        ...
        Do JW=1, NWB
            ...
            Do JB=BS(JW),BE(JW)
                ...
                Do SegNumI = IU, ID
                    ...
                    VolumeofSedimentBed1 = BedElevation(SegNumI)*sedcellwidth(SegNumI)*DLX(SegNumI)
                    ...
                    VolumeofSedimentBed2 = BedElevation(SegNumI)*sedcellwidth(SegNumI)*DLX(SegNumI)
                ...
                Do SegNumI = IU, ID
                    ...
                    If(ApplyCEMAPWRelease(SegNumI))Then
                        ...
                        QSS(KB(SegNumI),SegNumI) = QSS(KB(SegNumI),SegNumI) + CEMACumPWReleased(SegNumI)/dlt !m³/s
                         TSS(KB(SegNumI),SegNumI) = TSS(KB(SegNumI),SegNumI) + CEMACumPWReleased(SegNumI)/dlt*SD_T(1)  !Cm³/s      ! cb 5/22/15
