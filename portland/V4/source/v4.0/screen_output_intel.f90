...
SUBROUTINE RUN_W2 (DLG,CONTROL_NAME,ACTION)
  USE DFWIN, RENAMED => DLT; USE DFLOGM; USE MSCLIB; USE GLOBAL, ONLY: CDATE, CCTIME               !Rename DLT in DFWIN
  IMPLICIT NONE
...
SUBROUTINE SCREEN_UPDATE (DLG)
  ...
  WRITE (TEXT1,'(I0)')                KT;                         RESULT = DLGSET (DLG,SURFACE_LAYER,                    TEXT1)
  ...
  WRITE (TEXT1,'(1000(F0.2,2X))')     QIN;                        RESULT = DLGSET (DLG,BRANCH_INFLOW,                    TEXT1)
  WRITE (TEXT1,'(1000(F0.2,2X))')     TIN;                        RESULT = DLGSET (DLG,BRANCH_INFLOW_TEMPERATURE,        TEXT1)
  WRITE (TEXT1,'(1000(F0.2,2X))')     QDTR;                       RESULT = DLGSET (DLG,DIST_TRIBUTARY_INFLOW,            TEXT1)
  WRITE (TEXT1,'(1000(F0.2,2X))')     TDTR;                       RESULT = DLGSET (DLG,DIST_TRIBUTARY_INFLOW_TEMPERATURE,TEXT1)
  WRITE (TEXT1,'(1000(F0.3,2X))')     QTR;                        RESULT = DLGSET (DLG,TRIBUTARY_INFLOW,                 TEXT1)
  WRITE (TEXT1,'(1000(F0.2,2X))')     TTR;                        RESULT = DLGSET (DLG,TRIBUTARY_INFLOW_TEMPERATURE,     TEXT1)
  WRITE (TEXT1,'(1000(F0.2,2X))')     QSUM;                       RESULT = DLGSET (DLG,OUTFLOW,                          TEXT1)
  WRITE (TEXT1,'(1000(F0.2,2X))')     QWD;                        RESULT = DLGSET (DLG,WITHDRAWAL,                       TEXT1)
  WRITE (TEXT1,'(1000(F0.2,2X))')     QPU;                        RESULT = DLGSET (DLG,PUMPFLOW,                        TEXT1)
  WRITE (TEXT1,'(1000(F0.2,2X))')     QSP;                        RESULT = DLGSET (DLG,SPILLWAYFLOW,                    TEXT1)
  WRITE (TEXT1,'(1000(F0.2,2X))')     QPI;                        RESULT = DLGSET (DLG,PIPEFLOW,                        TEXT1)
  WRITE (TEXT1,'(1000(F0.2,2X))')     QGT;                        RESULT = DLGSET (DLG,GATEFLOW,                        TEXT1)
